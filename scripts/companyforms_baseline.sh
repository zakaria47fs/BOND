...
DATA_ROOT=$PROJECT_ROOT/dataset/CompanyFormsData/
...
# output
OUTPUT=$PROJECT_ROOT/outputs/companyforms/baseline/${MODEL_TYPE}_${EPOCH}_${LR}/
...
CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=$GPUID python run_ner.py --data_dir $DATA_ROOT \
